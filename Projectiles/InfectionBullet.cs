...
{
	public class InfectionBullet : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.CloneDefaults(ProjectileID.Bullet);
            projectile.name = "Infection Bullet";
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			int index = Dust.NewDust(projectile.position, projectile.width, projectile.height, 74, projectile.velocity.X * 0.15f, projectile.velocity.Y * 0.15f, 0, new Color(), 1.1f);
